...
{
    public class EntityUserStore :
        EntityUserStore<EntityUser>
    {
        public EntityUserStore(DbContext context) : base(context) { }
    }

    public class EntityUserStore<TUser> : UserStore<TUser, EntityRole, string, IdentityUserLogin, IdentityUserRole, IdentityUserClaim> where TUser:EntityUser
    {
        public EntityUserStore(DbContext context) : base(context) { }
    }
