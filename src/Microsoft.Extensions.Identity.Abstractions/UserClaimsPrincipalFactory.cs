...
namespace Microsoft.AspNetCore.Identity
{
        ...
        where TRole : class
    {
        ...
        /// </summary>
        /// <param name="userManager">The <see cref="UserManagerBase{TUser}"/> to retrieve user information from.</param>
        /// <param name="roleManager">The <see cref="RoleManagerBase{TRole}"/> to retrieve a user's roles from.</param>
        /// <param name="optionsAccessor">The configured <see cref="IdentityOptions"/>.</param>
        public UserClaimsPrincipalFactory(
            UserManagerBase<TUser> userManager, 
            RoleManagerBase<TRole> roleManager, 
        ...
        /// <summary>
        /// Gets the <see cref="UserManagerBase{TUser}"/> for this factory.
        /// </summary>
        /// <value>
        /// The current <see cref="UserManagerBase{TUser}"/> for this factory instance.
        /// </value>
        public UserManagerBase<TUser> UserManager { get; private set; }

        /// <summary>
        /// Gets the <see cref="RoleManagerBase{TRole}"/> for this factory.
        /// </summary>
        /// <value>
        /// The current <see cref="RoleManagerBase{TRole}"/> for this factory instance.
        /// </value>
        public RoleManagerBase<TRole> RoleManager { get; private set; }
