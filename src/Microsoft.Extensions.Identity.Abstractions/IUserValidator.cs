...
namespace Microsoft.AspNetCore.Identity
{
    ...
    public interface IUserValidator<TUser> where TUser : class
    {
        ...
        /// </summary>
        /// <param name="manager">The <see cref="UserManagerBase{TUser}"/> that can be used to retrieve user properties.</param>
        ...
        Task<IdentityResult> ValidateAsync(UserManagerBase<TUser> manager, TUser user);
    }
}