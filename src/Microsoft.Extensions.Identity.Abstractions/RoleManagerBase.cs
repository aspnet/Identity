...
namespace Microsoft.AspNetCore.Identity
{
    ...
    public class RoleManagerBase<TRole> : IDisposable where TRole : class
    {
        ...
        /// <summary>
        /// Constructs a new instance of <see cref="RoleManagerBase{TRole}"/>.
        /// </summary>
        ...
        public RoleManagerBase(IRoleStore<TRole> store,
            IEnumerable<IRoleValidator<TRole>> roleValidators,
            ILookupNormalizer keyNormalizer,
            IdentityErrorDescriber errors,
            ILogger<RoleManagerBase<TRole>> logger)
        {
            if (store == null)
            {
