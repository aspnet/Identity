...
namespace Microsoft.AspNetCore.Identity
{
    ...
    public interface IUserTwoFactorTokenProvider<TUser> where TUser : class
    {
        ...
        /// </remarks>
        Task<string> GenerateAsync(string purpose, UserManagerBase<TUser> manager, TUser user);
        ...
        /// </returns>
        Task<bool> ValidateAsync(string purpose, string token, UserManagerBase<TUser> manager, TUser user);
        ...
        /// </returns>
        Task<bool> CanGenerateTwoFactorTokenAsync(UserManagerBase<TUser> manager, TUser user);
    }
}