...
namespace Microsoft.AspNet.Identity
{
    ...
    public class UserManager<TUser> : IDisposable where TUser : class
    {
        ...
        private readonly Dictionary<string, IUserMessageProvider<TUser>> _msgProviders =
            new Dictionary<string, IUserMessageProvider<TUser>>();
        ...
        public UserManager(IUserStore<TUser> store, 
            ...
            IEnumerable<IUserMessageProvider<TUser>> msgProviders)
        {
            if (store == null)
            {
        ...
        /// </summary>
        /// <param name="provider"></param>
        public virtual void RegisterMessageProvider(IUserMessageProvider<TUser> provider)
        {
            ThrowIfDisposed();
            if (provider == null)
            {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public virtual async Task<IdentityResult> SendUserMessageAsync(TUser user, string messageProvider, IdentityMessage message, 
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ThrowIfDisposed();
            if (user == null)
            ...
            await _msgProviders[messageProvider].SendAsync(this, user, message, cancellationToken);
            return IdentityResult.Success;
        }
