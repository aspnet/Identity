...
namespace Microsoft.AspNetCore.Identity
{
    ...
    public class DataProtectorTokenProvider<TUser> : IUserTwoFactorTokenProvider<TUser> where TUser : class
    {
        ...
        /// <param name="manager">The <see cref="IUserManager{TUser}"/> to retrieve user properties from.</param>
        ...
        public virtual Task<bool> CanGenerateTwoFactorTokenAsync(IUserManager<TUser> manager, TUser user)
        {
