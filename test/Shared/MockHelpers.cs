...
namespace Microsoft.AspNetCore.Identity.Test
{
    public static class MockHelpers
    {
        ...
        public static Mock<IUserManager<TUser>> MockUserManager<TUser>() where TUser : class
        {
            var store = new Mock<IUserStore<TUser>>();
            var mgr = new Mock<IUserManager<TUser>>(store.Object, null, null, null, null, null, null, null, null);
