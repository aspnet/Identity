...
namespace Microsoft.AspNet.Identity.InMemory.Test
{
    public class InMemoryStoreTest
    {
        ...
        public async Task UserValidatorBlocksShortEmailsWhenRequiresUniqueEmail(string email)
        {
            ...
            manager.UserValidator = new UserValidator<IdentityUser>(new OptionsAccessor<IdentityOptions>(null)) { RequireUniqueEmail = true };
        ...
        private static UserManager<IdentityUser> CreateManager()
        {
            ...
            return new UserManager<IdentityUser>(services.BuildServiceProvider(), new InMemoryUserStore<IdentityUser>());
        }
