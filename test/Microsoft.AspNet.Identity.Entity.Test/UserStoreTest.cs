...
//            public Task Notify(string token, UserManager<IdentityUser, string> manager, IdentityUser user)
//            {
//                return Task.FromResult(0);
//            }

//            public Task<bool> IsValidProviderForUser(UserManager<IdentityUser, string> manager, IdentityUser user)
//            {
...
//            public Task<IdentityResult> Validate(RoleManager<IdentityRole, string> manager, IdentityRole role)
//            {
//                return Task.FromResult(IdentityResult.Failed(ErrorMessage));
//            }

//            public Task<IdentityResult> Validate(UserManager<IdentityUser, string> manager, IdentityUser user)
//            {
//                return Task.FromResult(IdentityResult.Failed(ErrorMessage));
//            }
//        }
...
//        }
        ...
        {
            public Task<string> Generate(string purpose, UserManager<IdentityUser, string> manager, IdentityUser user)
            {
            ...
            public async Task<bool> IsValidProviderForUser(UserManager<IdentityUser, string> manager, IdentityUser user)
            {
...
[UserName]             NVARCHAR (256) NOT NULL
        ...
        {
            return new UserManager<IdentityUser, string>(new UserStore<IdentityUser, string>(CreateContext()));
        }

        private static RoleManager<IdentityRole> CreateRoleManager()
        {
            return new RoleManager<IdentityRole>(new RoleStore<IdentityRole, string>(CreateContext()));
        }
