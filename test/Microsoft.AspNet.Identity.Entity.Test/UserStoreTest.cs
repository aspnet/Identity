...
namespace Microsoft.AspNet.Identity.Entity.Test
{
    public class UserStoreTest
    {
        ...
        public class ApplicationDbContext : IdentityEntityContext<ApplicationUser>
        {
        ...
        public static IdentityEntityContext CreateContext()
        {
            var serviceProvider = new ServiceCollection()
                .AddEntityFramework(s => s.AddSqlServer())
                .BuildServiceProvider();

            var db = new IdentityEntityContext(serviceProvider);
