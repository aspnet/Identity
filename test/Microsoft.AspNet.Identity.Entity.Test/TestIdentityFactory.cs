...
//#endif
        ...
        public static UserManager<EntityUser> CreateManager(DbContext context)
        {
            ...
            services.AddInstance<IUserStore<EntityUser>>(new EntityUserStore<EntityUser>(context));
            ...
            return new UserManager<EntityUser>(services.BuildServiceProvider(), new EntityUserStore<EntityUser>(context), optionsAccessor);
        }
