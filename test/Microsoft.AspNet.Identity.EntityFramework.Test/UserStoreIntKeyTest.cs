...
namespace Microsoft.AspNet.Identity.EntityFramework.Test
{
    ...
    {
        private const string ConnectionString = @"Server=(localdb)\v11.0;Database=SqlUserStoreIntTest;Trusted_Connection=True;";
        ...
        public void CanCreateUserUsingEF()
        {
            using (var db = CreateContext())
            {
                ...
                db.Users.Add(new IdentityUser<int> { /*Id = guid, */UserName = guid});
                db.SaveChanges();
        ...
        public static IdentityDbContext<IdentityUser<int>, IdentityRole<int>, int> CreateContext(bool delete = false)
        {
            ...
            var db = new IdentityDbContext<IdentityUser<int>, IdentityRole<int>, int>(serviceProvider,
        ...
        public static UserManager<IdentityUser<int>> CreateManager(DbContext context)
        {
            return MockHelpers.CreateManager(() => new UserStore<IdentityUser<int>, IdentityRole<int>, DbContext, int>(context));
        }

        public static UserManager<IdentityUser<int>> CreateManager()
        {
        ...
        public static RoleManager<IdentityRole<int>> CreateRoleManager()
        {
        ...
        public async Task CanCreateUsingManager()
        {
            ...
            var guid = Guid.NewGuid().ToString();
            var user = new IdentityUser<int> { UserName = "New"+guid };
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("CanDeleteUser");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await manager.DeleteAsync(user));
        ...
        public async Task CanUpdateUserName()
        {
            ...
            var user = new IdentityUser<int>(oldName);
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("CanUpdatePasswordUsingHasher");
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("RemoveClaimForMe");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await manager.DeleteAsync(user));
        }
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("UserValidatorCanBlockCreate");
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("UserValidatorCanBlockUpdate");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            manager.UserValidator = new AlwaysBadValidator();
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("UserValidatorBlocksShortEmailsWhenRequiresUniqueEmail") { Email = email };
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("UserValidatorBlocksInvalidEmailsWhenRequiresUniqueEmail") { Email = email };
            manager.Options.User.RequireUniqueEmail = true;
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("AddPasswordBlocked");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("ChangePasswordBlocked");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, "password"));
            manager.PasswordValidator = new AlwaysBadValidator();
        ...
        {
            var manager = CreateManager();
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(new IdentityUser<int>("CanCreateUserNoPassword")));
        ...
        public async Task CanCreateUserAddLogin()
        {
            ...
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(new IdentityUser<int>(userName)));
        ...
        public async Task CanCreateUserLoginAndAddPassword()
        {
            ...
            var user = new IdentityUser<int>("CreateUserLoginAddPasswordTest");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await manager.AddLoginAsync(user, login));
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("CannotAddAnotherPassword");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, "Password"));
            Assert.True(await manager.HasPasswordAsync(user));
            IdentityResultAssert.IsFailure(await manager.AddPasswordAsync(user, "password"),
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("CreateUserAddRemoveLoginTest");
            var login = new UserLoginInfo("Provider", "key");
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("RemovePasswordTest");
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("ChangePasswordTest");
            const string password = "password";
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("ClaimsAddRemove") { Id = 10000 };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("user");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, "password"));
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("AddDupeUserNameFails");
            var user2 = new IdentityUser<int>("AddDupeUserNameFails");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("AddDupeEmailAllowedByDefault") { Email = "yup@yup.com" };
            var user2 = new IdentityUser<int>("AddDupeEmailAllowedByDefault2") { Email = "yup@yup.com" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task AddDupeEmailFallsWhenUniqueEmailRequired()
        {
            var manager = CreateManager();
            manager.Options.User.RequireUniqueEmail = true;
            var user = new IdentityUser<int>("AddDupeEmailFallsWhenUniqueEmailRequired") { Email = "dupeEmailTrue@yup.com" };
            var user2 = new IdentityUser<int>("AddDupeEmailFallsWhenUniqueEmailRequiredDupe") { Email = "dupeEmailTrue@yup.com" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("UpdateSecurityStampActuallyChanges");
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("DupeLogin");
        ...
        public async Task CanFindByEmail()
        {
            ...
            var user = new IdentityUser<int>(userName) { Email = email };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task EnsureRoleClaimNavigationProperty()
        {
            ...
            var r = new IdentityRole<int>("EnsureRoleClaimNavigationProperty");
        ...
        public async Task ClaimsIdentityCreatesExpectedClaims()
        {
            ...
            var user = new IdentityUser<int>("ClaimsIdentityCreatesExpectedClaims");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            var admin = new IdentityRole<int>("Admin");
            var local = new IdentityRole<int>("Local");
            ...
            var claimsFactory = new ClaimsIdentityFactory<IdentityUser<int>, IdentityRole<int>>(manager, role);
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("ConfirmEmailFalseByDefaultTest");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            Assert.False(await manager.IsEmailConfirmedAsync(user));
        }

        // TODO: No token provider implementations yet
        private class StaticTokenProvider : IUserTokenProvider<IdentityUser<int>>
        {
            public Task<string> GenerateAsync(string purpose, UserManager<IdentityUser<int>> manager,
                IdentityUser<int> user, CancellationToken token)
            {
                return Task.FromResult(MakeToken(purpose, user));
            }

            public Task<bool> ValidateAsync(string purpose, string token, UserManager<IdentityUser<int>> manager,
                IdentityUser<int> user, CancellationToken cancellationToken)
            {
                return Task.FromResult(token == MakeToken(purpose, user));
            }

            public Task NotifyAsync(string token, UserManager<IdentityUser<int>> manager, IdentityUser<int> user, CancellationToken cancellationToken)
            {
                return Task.FromResult(0);
            }

            public Task<bool> IsValidProviderForUserAsync(UserManager<IdentityUser<int>> manager, IdentityUser<int> user, CancellationToken token)
            {
                return Task.FromResult(true);
            }

            private static string MakeToken(string purpose, IdentityUser<int> user)
            {
        ...
        public async Task CanResetPasswordWithStaticTokenProvider()
        {
            ...
            var user = new IdentityUser<int>("CanResetPasswordWithStaticTokenProvider");
            const string password = "password";
            const string newPassword = "newpassword";
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, password));
            var stamp = user.SecurityStamp;
        ...
        public async Task PasswordValidatorCanBlockResetPasswordWithStaticTokenProvider()
        {
            var manager = CreateManager();
            manager.UserTokenProvider = new StaticTokenProvider();
            var user = new IdentityUser<int>("PasswordValidatorCanBlockResetPasswordWithStaticTokenProvider");
            const string password = "password";
            const string newPassword = "newpassword";
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, password));
            var stamp = user.SecurityStamp;
        ...
        public async Task ResetPasswordWithStaticTokenProviderFailsWithWrongToken()
        {
            var manager = CreateManager();
            manager.UserTokenProvider = new StaticTokenProvider();
            var user = new IdentityUser<int>("ResetPasswordWithStaticTokenProviderFailsWithWrongToken");
            const string password = "password";
            const string newPassword = "newpassword";
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, password));
            var stamp = user.SecurityStamp;
        ...
        public async Task CanGenerateAndVerifyUserTokenWithStaticTokenProvider()
        {
            var manager = CreateManager();
            manager.UserTokenProvider = new StaticTokenProvider();
            var user = new IdentityUser<int>("CanGenerateAndVerifyUserTokenWithStaticTokenProvider");
            var user2 = new IdentityUser<int>("CanGenerateAndVerifyUserTokenWithStaticTokenProvider2");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user2));
        ...
        public async Task CanConfirmEmailWithStaticToken()
        {
            var manager = CreateManager();
            manager.UserTokenProvider = new StaticTokenProvider();
            var user = new IdentityUser<int>("CanConfirmEmailWithStaticToken");
        ...
        public async Task ConfirmEmailWithStaticTokenFailsWithWrongToken()
        {
            var manager = CreateManager();
            manager.UserTokenProvider = new StaticTokenProvider();
            var user = new IdentityUser<int>("ConfirmEmailWithStaticTokenFailsWithWrongToken");
            Assert.False(user.EmailConfirmed);
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        //{
        //    var manager = CreateManager();
        //    var user = new IdentityUser<int>("test");
        //    Assert.False(user.EmailConfirmed);
        //    IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, "password"));
        //    var token = await manager.GenerateEmailConfirmationTokenAsync(user);
        //    Assert.NotNull(token);
        ...
        public async Task SingleFailureLockout()
        {
            ...
            var user = new IdentityUser<int>("SingleFailureLockout");
        ...
        public async Task TwoFailureLockout()
        {
            ...
            var user = new IdentityUser<int>("twoFailureLockout");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
            Assert.False(await mgr.IsLockedOutAsync(user));
        ...
        public async Task ResetAccessCountPreventsLockout()
        {
            ...
            mgr.Options.Lockout.EnabledByDefault = true;
            mgr.Options.Lockout.MaxFailedAccessAttempts = 2;
            var user = new IdentityUser<int>("ResetAccessCountPreventsLockout");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
            Assert.False(await mgr.IsLockedOutAsync(user));
        ...
        public async Task CanEnableLockoutManuallyAndLockout()
        {
            ...
            mgr.Options.Lockout.DefaultLockoutTimeSpan = TimeSpan.FromHours(1);
            mgr.Options.Lockout.MaxFailedAccessAttempts = 2;
            var user = new IdentityUser<int>("manualLockout");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
        ...
        public async Task UserNotLockedOutWithNullDateTimeAndIsSetToNullDate()
        {
            var mgr = CreateManager();
            mgr.Options.Lockout.EnabledByDefault = true;
            var user = new IdentityUser<int>("UserNotLockedOutWithNullDateTimeAndIsSetToNullDate");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
        ...
        {
            var mgr = CreateManager();
            var user = new IdentityUser<int>("LockoutFailsIfNotEnabled");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.False(await mgr.GetLockoutEnabledAsync(user));
            Assert.False(user.LockoutEnabled);
        ...
        public async Task LockoutEndToUtcNowMinus1SecInUserShouldNotBeLockedOut()
        {
            var mgr = CreateManager();
            mgr.Options.Lockout.EnabledByDefault = true;
            var user = new IdentityUser<int>("LockoutEndToUtcNowMinus1SecInUserShouldNotBeLockedOut") { LockoutEnd = DateTime.UtcNow.AddSeconds(-1) };
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
            Assert.False(await mgr.IsLockedOutAsync(user));
        ...
        public async Task LockoutEndToUtcNowSubOneSecondWithManagerShouldNotBeLockedOut()
        {
            var mgr = CreateManager();
            mgr.Options.Lockout.EnabledByDefault = true;
            var user = new IdentityUser<int>("LockoutEndToUtcNowSubOneSecondWithManagerShouldNotBeLockedOut");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
        ...
        public async Task LockoutEndToUtcNowPlus5ShouldBeLockedOut()
        {
            var mgr = CreateManager();
            mgr.Options.Lockout.EnabledByDefault = true;
            var user = new IdentityUser<int>("LockoutEndToUtcNowPlus5ShouldBeLockedOut") { LockoutEnd = DateTime.UtcNow.AddMinutes(5) };
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
            Assert.True(await mgr.IsLockedOutAsync(user));
        ...
        public async Task UserLockedOutWithDateTimeLocalKindNowPlus30()
        {
            var mgr = CreateManager();
            mgr.Options.Lockout.EnabledByDefault = true;
            var user = new IdentityUser<int>("UserLockedOutWithDateTimeLocalKindNowPlus30");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
        ...
        public async Task CanCreateRoleTest()
        {
            ...
            var role = new IdentityRole<int>("CanCreateRoleTest");
            Assert.False(await manager.RoleExistsAsync(role.Name));
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(role));
            Assert.True(await manager.RoleExistsAsync(role.Name));
        }

        private class AlwaysBadValidator : IUserValidator<IdentityUser<int>>, IRoleValidator<IdentityRole<int>>,
            IPasswordValidator<IdentityUser<int>>
        {
            public const string ErrorMessage = "I'm Bad.";

            public Task<IdentityResult> ValidateAsync(string password, UserManager<IdentityUser<int>> manager, CancellationToken token)
            {
                return Task.FromResult(IdentityResult.Failed(ErrorMessage));
            }

            public Task<IdentityResult> ValidateAsync(RoleManager<IdentityRole<int>> manager, IdentityRole<int> role, CancellationToken token)
            {
                return Task.FromResult(IdentityResult.Failed(ErrorMessage));
            }

            public Task<IdentityResult> ValidateAsync(UserManager<IdentityUser<int>> manager, IdentityUser<int> user, CancellationToken token)
            {
                return Task.FromResult(IdentityResult.Failed(ErrorMessage));
            }
        }
        ...
        public async Task BadValidatorBlocksCreateRole()
        {
            ...
            IdentityResultAssert.IsFailure(await manager.CreateAsync(new IdentityRole<int>("blocked")),
                AlwaysBadValidator.ErrorMessage);
        }
        ...
        {
            var manager = CreateRoleManager();
            var role = new IdentityRole<int>("BadValidatorBlocksRoleUpdate");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(role));
        ...
        {
            var manager = CreateRoleManager();
            var role = new IdentityRole<int>("CanDeleteRole");
            Assert.False(await manager.RoleExistsAsync(role.Name));
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(role));
        ...
        {
            var manager = CreateRoleManager();
            var role = new IdentityRole<int>("CanRoleFindById");
        ...
        {
            var manager = CreateRoleManager();
            var role = new IdentityRole<int>("CanRoleFindByName");
        ...
        public async Task CanUpdateRoleName()
        {
            ...
            var role = new IdentityRole<int>("CanUpdateRoleName");
            Assert.False(await manager.RoleExistsAsync(role.Name));
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(role));
            Assert.True(await manager.RoleExistsAsync(role.Name));
        ...
        public async Task DeleteRoleNonEmptySucceedsTest()
        {
            ...
            var role = new IdentityRole<int>("deleteNonEmpty");
            Assert.False(await roleMgr.RoleExistsAsync(role.Name));
            IdentityResultAssert.IsSuccess(await roleMgr.CreateAsync(role));
            var user = new IdentityUser<int>("t");
        ...
        {
            var manager = CreateRoleManager();
            var role = new IdentityRole<int>("CreateRoleFailsIfExists");
            Assert.False(await manager.RoleExistsAsync(role.Name));
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(role));
            Assert.True(await manager.RoleExistsAsync(role.Name));
            var role2 = new IdentityRole<int>("CreateRoleFailsIfExists");
        ...
        public async Task CanAddUsersToRole()
        {
            ...
            var manager = CreateManager(context);
            var roleManager = CreateRoleManager(context);
            var role = new IdentityRole<int>("CanAddUsersToRole");
        ...
        private List<IdentityUser<int>> GenerateUsers(string userNamePrefix, int count)
        {
            var users = new List<IdentityUser<int>>(count);
            for (var i=0; i<count; i++)
            {
                users.Add(new IdentityUser<int>(userNamePrefix + i));
            }
            return users;
        }

        private List<IdentityRole<int>> GenerateRoles(string namePrefix, int count)
        {
            var roles = new List<IdentityRole<int>>(count);
            for (var i = 0; i < count; i++)
            {
                roles.Add(new IdentityRole<int>(namePrefix + i));
            }
            return roles;
        }
        ...
        public async Task RemoveUserFromRoleWithMultipleRoles()
        {
            ...
            var userManager = CreateManager(context);
            var roleManager = CreateRoleManager(context);
            var user = new IdentityUser<int>("RemoveUserFromRoleWithMultipleRoles");
        ...
        public async Task CanRemoveUsersFromRole()
        {
            ...
            var r = new IdentityRole<int>("CanRemoveUsersFromRole");
            IdentityResultAssert.IsSuccess(await roleManager.CreateAsync(r));
            foreach (var u in users)
            {
                IdentityResultAssert.IsSuccess(await userManager.AddToRoleAsync(u, r.Name));
        ...
        public async Task RemoveUserNotInRoleFails()
        {
            ...
            var role = new IdentityRole<int>("RemoveUserNotInRoleFails");
            var user = new IdentityUser<int>("RemoveUserNotInRoleFails");
            IdentityResultAssert.IsSuccess(await userMgr.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await roleMgr.CreateAsync(role));
        ...
        {
            var manager = CreateManager();
            var u = new IdentityUser<int>("AddUserToUnknownRoleFails");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(u));
        ...
        public async Task AddUserToRoleFailsIfAlreadyInRole()
        {
            ...
            var userMgr = CreateManager(context);
            var roleMgr = CreateRoleManager(context);
            var role = new IdentityRole<int>("AddUserToRoleFailsIfAlreadyInRole");
            var user = new IdentityUser<int>("AddUserToRoleFailsIfAlreadyInRoleUser");
            IdentityResultAssert.IsSuccess(await userMgr.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await roleMgr.CreateAsync(role));
            IdentityResultAssert.IsSuccess(await userMgr.AddToRoleAsync(user, role.Name));
        ...
        {
            var roleMgr = CreateRoleManager();
            var role = new IdentityRole<int>("CanFindRoleByNameWithManager");
            IdentityResultAssert.IsSuccess(await roleMgr.CreateAsync(role));
        ...
        {
            var roleMgr = CreateRoleManager();
            var role = new IdentityRole<int>("CanFindRoleWithManager") { Id = 1024 };
            IdentityResultAssert.IsSuccess(await roleMgr.CreateAsync(role));
            //Assert.Equal(role, await roleMgr.FindByIdAsync(role.Id.ToString()));
            Assert.NotNull(await roleMgr.FindByIdAsync(role.Id.ToString()));
        }
        ...
        public async Task SetPhoneNumberTest()
        {
            ...
            var user = new IdentityUser<int>(userName) { PhoneNumber = "123-456-7890" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        private class EmailTokenProvider : IUserTokenProvider<IdentityUser<int>>
        {
            public Task<string> GenerateAsync(string purpose, UserManager<IdentityUser<int>> manager, IdentityUser<int> user, CancellationToken token)
            {
            ...
            public async Task<bool> IsValidProviderForUserAsync(UserManager<IdentityUser<int>> manager, IdentityUser<int> user, CancellationToken token)
            {
        ...
        private class SmsTokenProvider : IUserTokenProvider<IdentityUser<int>>
        {
            public Task<string> GenerateAsync(string purpose, UserManager<IdentityUser<int>> manager, IdentityUser<int> user, CancellationToken token)
            {
                return Task.FromResult(MakeToken(purpose));
        ...
        public async Task CanEmailTwoFactorToken()
        {
            ...
            var user = new IdentityUser<int>("CanEmailTwoFactorToken") { Email = "foo@foo.com" };
            const string password = "password";
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, password));
            var stamp = user.SecurityStamp;
            Assert.NotNull(stamp);
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("NotifyFail");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            await
        ...
        //    manager.EmailService = messageService;
        //    const string factorId = "EmailCode";
        //    manager.RegisterTwoFactorProvider(factorId, new EmailTokenProvider<IdentityUser<int>>
        //    {
        //        Subject = "Security Code",
        //        BodyFormat = "Your code is: {0}"
        //    });
        //    var user = new IdentityUser<int>("EmailCodeTest") { Email = "foo@foo.com" };
        //    const string password = "password";
        //    IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, password));
        //    var stamp = user.SecurityStamp;
        //    Assert.NotNull(stamp);
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("EnableTwoFactorChangesSecurityStamp");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            var stamp = user.SecurityStamp;
            Assert.NotNull(stamp);
        ...
        public async Task CanSendSms()
        {
            ...
            var user = new IdentityUser<int>("SmsTest") { PhoneNumber = "4251234567" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task CanSendEmail()
        {
            ...
            var messageService = new TestMessageService();
            manager.EmailService = messageService;
            var user = new IdentityUser<int>("CanSendEmail") { Email = "foo@foo.com" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task CanSmsTwoFactorToken()
        {
            ...
            var user = new IdentityUser<int>("CanSmsTwoFactorToken") { PhoneNumber = "4251234567" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            var stamp = user.SecurityStamp;
            Assert.NotNull(stamp);
            var token = await manager.GenerateTwoFactorTokenAsync(user, factorId);
        ...
        //    manager.SmsService = messageService;
        //    const string factorId = "PhoneCode";
        //    manager.RegisterTwoFactorProvider(factorId, new PhoneNumberTokenProvider<IdentityUser<int>>
        //    {
        //        MessageFormat = "Your code is: {0}"
        //    });
        //    var user = new IdentityUser<int>("PhoneCodeTest") { PhoneNumber = "4251234567" };
        //    IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        //    var stamp = user.SecurityStamp;
        //    Assert.NotNull(stamp);
        //    var token = await manager.GenerateTwoFactorTokenAsync(user, factorId);
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("GenerateTwoFactorWithUnknownFactorProviderWillThrow");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new IdentityUser<int>("GetValidTwoFactorTestEmptyWithNoProviders");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task CanGetValidTwoFactor()
        {
            ...
            var user = new IdentityUser<int>("CanGetValidTwoFactor");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            var factors = await manager.GetValidTwoFactorProvidersAsync(user);
            Assert.NotNull(factors);
            Assert.True(!factors.Any());
        ...
        //    manager.RegisterTwoFactorProvider(factorId, new PhoneNumberTokenProvider<IdentityUser<int>>());
        //    var user = new IdentityUser<int>("PhoneCodeTest");
        ...
        public async Task VerifyTokenFromWrongTokenProviderFails()
        {
            ...
            var user = new IdentityUser<int>("WrongTokenProviderTest") { PhoneNumber = "4251234567" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task VerifyWithWrongSmsTokenFails()
        {
            ...
            const string factorId = "PhoneCode";
            manager.RegisterTwoFactorProvider(factorId, new SmsTokenProvider());
            var user = new IdentityUser<int>("VerifyWithWrongSmsTokenFails") { PhoneNumber = "4251234567" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
