...
namespace Microsoft.AspNet.Identity.EntityFramework.Test
{
    ...
    {
        private const string ConnectionString = @"Server=(localdb)\v11.0;Database=SqlUserStoreGuidTest;Trusted_Connection=True;";
        ...
        public async Task EnsureStartupUsageWorks()
        {
            ...
            builder.UseServices(services =>
            {
                ...
                services.AddIdentitySqlServer<ApplicationDbContext, ApplicationUser, IdentityRole<Guid>, Guid>();
        ...
        public async Task EnsureStartupOptionsChangeWorks()
        {
            ...
            {
                services.AddEntityFramework().AddSqlServer();
                services.AddIdentitySqlServer<ApplicationDbContext, ApplicationUser, IdentityRole<Guid>, Guid>(b => b.SetupOptions(options =>
                {
        ...
        public static ApplicationDbContext CreateContext(bool delete = false)
        {
        ...
        public static UserManager<ApplicationUser> CreateManager(ApplicationDbContext context)
        {
            return MockHelpers.CreateManager(() => new ApplicationUserStore(context));
        }

        public static UserManager<ApplicationUser> CreateManager()
        {
            return CreateManager(CreateContext());
        }

        public static RoleManager<ApplicationRole> CreateRoleManager(ApplicationDbContext context)
        {
            var services = new ServiceCollection();
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("CanDeleteUser");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await manager.DeleteAsync(user));
        ...
        public async Task CanUpdateUserName()
        {
            ...
            var user = new ApplicationUser(oldName);
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("CanUpdatePasswordUsingHasher");
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("RemoveClaimForMe");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await manager.DeleteAsync(user));
        }
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("UserValidatorCanBlockCreate");
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("UserValidatorCanBlockUpdate");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            manager.UserValidator = new AlwaysBadValidator();
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("UserValidatorBlocksShortEmailsWhenRequiresUniqueEmail") { Email = email };
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("UserValidatorBlocksInvalidEmailsWhenRequiresUniqueEmail") { Email = email };
            manager.Options.User.RequireUniqueEmail = true;
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("AddPasswordBlocked");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("ChangePasswordBlocked");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, "password"));
            manager.PasswordValidator = new AlwaysBadValidator();
        ...
        {
            var manager = CreateManager();
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(new ApplicationUser("CanCreateUserNoPassword")));
        ...
        public async Task CanCreateUserAddLogin()
        {
            ...
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(new ApplicationUser(userName)));
        ...
        public async Task CanCreateUserLoginAndAddPassword()
        {
            ...
            var user = new ApplicationUser("CreateUserLoginAddPasswordTest");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await manager.AddLoginAsync(user, login));
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("CannotAddAnotherPassword");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, "Password"));
            Assert.True(await manager.HasPasswordAsync(user));
            IdentityResultAssert.IsFailure(await manager.AddPasswordAsync(user, "password"),
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("CreateUserAddRemoveLoginTest");
            var login = new UserLoginInfo("Provider", "key");
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("RemovePasswordTest");
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("ChangePasswordTest");
            const string password = "password";
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("ClaimsAddRemove") { Id = Guid.NewGuid() };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("AddDupeUserNameFails");
            var user2 = new ApplicationUser("AddDupeUserNameFails");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("AddDupeEmailAllowedByDefault") { Email = "yup@yup.com" };
            var user2 = new ApplicationUser("AddDupeEmailAllowedByDefault2") { Email = "yup@yup.com" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task AddDupeEmailFallsWhenUniqueEmailRequired()
        {
            var manager = CreateManager();
            manager.Options.User.RequireUniqueEmail = true;
            var user = new ApplicationUser("AddDupeEmailFallsWhenUniqueEmailRequired") { Email = "dupeEmailTrue@yup.com" };
            var user2 = new ApplicationUser("AddDupeEmailFallsWhenUniqueEmailRequiredDupe") { Email = "dupeEmailTrue@yup.com" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("UpdateSecurityStampActuallyChanges");
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("DupeLogin");
        ...
        public async Task EnsureRoleClaimNavigationProperty()
        {
            ...
            var r = new ApplicationRole("EnsureRoleClaimNavigationProperty");
        ...
        public async Task ClaimsIdentityCreatesExpectedClaims()
        {
            ...
            var user = new ApplicationUser("ClaimsIdentityCreatesExpectedClaims");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            var admin = new ApplicationRole("Admin");
            var local = new ApplicationRole("Local");
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("ConfirmEmailFalseByDefaultTest");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task CanResetPasswordWithStaticTokenProvider()
        {
            ...
            var user = new ApplicationUser("CanResetPasswordWithStaticTokenProvider");
            const string password = "password";
            const string newPassword = "newpassword";
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, password));
            var stamp = user.SecurityStamp;
        ...
        public async Task PasswordValidatorCanBlockResetPasswordWithStaticTokenProvider()
        {
            var manager = CreateManager();
            manager.UserTokenProvider = new StaticTokenProvider();
            var user = new ApplicationUser("PasswordValidatorCanBlockResetPasswordWithStaticTokenProvider");
            const string password = "password";
            const string newPassword = "newpassword";
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, password));
            var stamp = user.SecurityStamp;
        ...
        public async Task ResetPasswordWithStaticTokenProviderFailsWithWrongToken()
        {
            var manager = CreateManager();
            manager.UserTokenProvider = new StaticTokenProvider();
            var user = new ApplicationUser("ResetPasswordWithStaticTokenProviderFailsWithWrongToken");
            const string password = "password";
            const string newPassword = "newpassword";
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, password));
            var stamp = user.SecurityStamp;
        ...
        public async Task CanGenerateAndVerifyUserTokenWithStaticTokenProvider()
        {
            var manager = CreateManager();
            manager.UserTokenProvider = new StaticTokenProvider();
            var user = new ApplicationUser("CanGenerateAndVerifyUserTokenWithStaticTokenProvider");
            var user2 = new ApplicationUser("CanGenerateAndVerifyUserTokenWithStaticTokenProvider2");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user2));
        ...
        public async Task CanConfirmEmailWithStaticToken()
        {
            var manager = CreateManager();
            manager.UserTokenProvider = new StaticTokenProvider();
            var user = new ApplicationUser("CanConfirmEmailWithStaticToken");
        ...
        public async Task ConfirmEmailWithStaticTokenFailsWithWrongToken()
        {
            var manager = CreateManager();
            manager.UserTokenProvider = new StaticTokenProvider();
            var user = new ApplicationUser("ConfirmEmailWithStaticTokenFailsWithWrongToken");
            Assert.False(user.EmailConfirmed);
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task SingleFailureLockout()
        {
            ...
            var user = new ApplicationUser("SingleFailureLockout");
        ...
        public async Task TwoFailureLockout()
        {
            ...
            var user = new ApplicationUser("twoFailureLockout");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
            Assert.False(await mgr.IsLockedOutAsync(user));
        ...
        public async Task ResetAccessCountPreventsLockout()
        {
            ...
            mgr.Options.Lockout.EnabledByDefault = true;
            mgr.Options.Lockout.MaxFailedAccessAttempts = 2;
            var user = new ApplicationUser("ResetAccessCountPreventsLockout");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
            Assert.False(await mgr.IsLockedOutAsync(user));
        ...
        public async Task CanEnableLockoutManuallyAndLockout()
        {
            ...
            mgr.Options.Lockout.DefaultLockoutTimeSpan = TimeSpan.FromHours(1);
            mgr.Options.Lockout.MaxFailedAccessAttempts = 2;
            var user = new ApplicationUser("manualLockout");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
        ...
        public async Task UserNotLockedOutWithNullDateTimeAndIsSetToNullDate()
        {
            var mgr = CreateManager();
            mgr.Options.Lockout.EnabledByDefault = true;
            var user = new ApplicationUser("UserNotLockedOutWithNullDateTimeAndIsSetToNullDate");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
        ...
        {
            var mgr = CreateManager();
            var user = new ApplicationUser("LockoutFailsIfNotEnabled");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.False(await mgr.GetLockoutEnabledAsync(user));
            Assert.False(user.LockoutEnabled);
        ...
        public async Task LockoutEndToUtcNowMinus1SecInUserShouldNotBeLockedOut()
        {
            var mgr = CreateManager();
            mgr.Options.Lockout.EnabledByDefault = true;
            var user = new ApplicationUser("LockoutEndToUtcNowMinus1SecInUserShouldNotBeLockedOut") { LockoutEnd = DateTime.UtcNow.AddSeconds(-1) };
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
            Assert.False(await mgr.IsLockedOutAsync(user));
        ...
        public async Task LockoutEndToUtcNowSubOneSecondWithManagerShouldNotBeLockedOut()
        {
            var mgr = CreateManager();
            mgr.Options.Lockout.EnabledByDefault = true;
            var user = new ApplicationUser("LockoutEndToUtcNowSubOneSecondWithManagerShouldNotBeLockedOut");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
        ...
        public async Task LockoutEndToUtcNowPlus5ShouldBeLockedOut()
        {
            var mgr = CreateManager();
            mgr.Options.Lockout.EnabledByDefault = true;
            var user = new ApplicationUser("LockoutEndToUtcNowPlus5ShouldBeLockedOut") { LockoutEnd = DateTime.UtcNow.AddMinutes(5) };
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
            Assert.True(await mgr.IsLockedOutAsync(user));
        ...
        public async Task UserLockedOutWithDateTimeLocalKindNowPlus30()
        {
            var mgr = CreateManager();
            mgr.Options.Lockout.EnabledByDefault = true;
            var user = new ApplicationUser("UserLockedOutWithDateTimeLocalKindNowPlus30");
            IdentityResultAssert.IsSuccess(await mgr.CreateAsync(user));
            Assert.True(await mgr.GetLockoutEnabledAsync(user));
            Assert.True(user.LockoutEnabled);
        ...
        public async Task CanCreateRoleTest()
        {
            ...
            var role = new ApplicationRole("CanCreateRoleTest");
        ...
        public async Task BadValidatorBlocksCreateRole()
        {
            ...
            IdentityResultAssert.IsFailure(await manager.CreateAsync(new ApplicationRole("blocked")),
                AlwaysBadValidator.ErrorMessage);
        }
        ...
        {
            var manager = CreateRoleManager();
            var role = new ApplicationRole("BadValidatorBlocksRoleUpdate");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(role));
        ...
        {
            var manager = CreateRoleManager();
            var role = new ApplicationRole("CanDeleteRole");
            Assert.False(await manager.RoleExistsAsync(role.Name));
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(role));
        ...
        {
            var manager = CreateRoleManager();
            var role = new ApplicationRole("CanRoleFindById");
        ...
        {
            var manager = CreateRoleManager();
            var role = new ApplicationRole("CanRoleFindByName");
        ...
        public async Task CanUpdateRoleName()
        {
            ...
            var role = new ApplicationRole("CanUpdateRoleName");
            Assert.False(await manager.RoleExistsAsync(role.Name));
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(role));
            Assert.True(await manager.RoleExistsAsync(role.Name));
        ...
        {
            var manager = CreateRoleManager();
            var role = new ApplicationRole("CreateRoleFailsIfExists");
            Assert.False(await manager.RoleExistsAsync(role.Name));
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(role));
            Assert.True(await manager.RoleExistsAsync(role.Name));
            var role2 = new ApplicationRole("CreateRoleFailsIfExists");
        ...
        public async Task CanAddUsersToRole()
        {
            ...
            var manager = CreateManager(context);
            var roleManager = CreateRoleManager(context);
            var role = new ApplicationRole("CanAddUsersToRole");
        ...
        private List<ApplicationUser> GenerateUsers(string userNamePrefix, int count)
        {
            ...
            {
                users.Add(new ApplicationUser(userNamePrefix + i));
            }
            return users;
        }
        ...
        private List<ApplicationRole> GenerateRoles(string namePrefix, int count)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                roles.Add(new ApplicationRole(namePrefix + i));
            }
            return roles;
        }
        ...
        public async Task RemoveUserFromRoleWithMultipleRoles()
        {
            ...
            var userManager = CreateManager(context);
            var roleManager = CreateRoleManager(context);
            var user = new ApplicationUser("RemoveUserFromRoleWithMultipleRoles");
        ...
        public async Task CanRemoveUsersFromRole()
        {
            ...
            var r = new ApplicationRole("CanRemoveUsersFromRole");
            IdentityResultAssert.IsSuccess(await roleManager.CreateAsync(r));
            foreach (var u in users)
            {
                IdentityResultAssert.IsSuccess(await userManager.AddToRoleAsync(u, r.Name));
        ...
        public async Task RemoveUserNotInRoleFails()
        {
            ...
            var role = new ApplicationRole("RemoveUserNotInRoleFails");
            var user = new ApplicationUser("RemoveUserNotInRoleFails");
            IdentityResultAssert.IsSuccess(await userMgr.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await roleMgr.CreateAsync(role));
        ...
        {
            var manager = CreateManager();
            var u = new ApplicationUser("AddUserToUnknownRoleFails");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(u));
        ...
        public async Task AddUserToRoleFailsIfAlreadyInRole()
        {
            ...
            var userMgr = CreateManager(context);
            var roleMgr = CreateRoleManager(context);
            var role = new ApplicationRole("AddUserToRoleFailsIfAlreadyInRole");
            var user = new ApplicationUser("AddUserToRoleFailsIfAlreadyInRoleUser");
            IdentityResultAssert.IsSuccess(await userMgr.CreateAsync(user));
            IdentityResultAssert.IsSuccess(await roleMgr.CreateAsync(role));
            IdentityResultAssert.IsSuccess(await userMgr.AddToRoleAsync(user, role.Name));
        ...
        {
            var roleMgr = CreateRoleManager();
            var role = new ApplicationRole("CanFindRoleByNameWithManager");
            IdentityResultAssert.IsSuccess(await roleMgr.CreateAsync(role));
        ...
        {
            var roleMgr = CreateRoleManager();
            var role = new ApplicationRole("CanFindRoleWithManager") { Id = Guid.NewGuid() };
            IdentityResultAssert.IsSuccess(await roleMgr.CreateAsync(role));
        ...
        public async Task SetPhoneNumberTest()
        {
            ...
            var user = new ApplicationUser(userName) { PhoneNumber = "123-456-7890" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task CanEmailTwoFactorToken()
        {
            ...
            var user = new ApplicationUser("CanEmailTwoFactorToken") { Email = "foo@foo.com" };
            const string password = "password";
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user, password));
            var stamp = user.SecurityStamp;
            Assert.NotNull(stamp);
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("NotifyFail");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            await
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("EnableTwoFactorChangesSecurityStamp");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            var stamp = user.SecurityStamp;
            Assert.NotNull(stamp);
        ...
        public async Task CanSendSms()
        {
            ...
            var user = new ApplicationUser("SmsTest") { PhoneNumber = "4251234567" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task CanSendEmail()
        {
            ...
            var messageService = new TestMessageService();
            manager.EmailService = messageService;
            var user = new ApplicationUser("CanSendEmail") { Email = "foo@foo.com" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task CanSmsTwoFactorToken()
        {
            ...
            var user = new ApplicationUser("CanSmsTwoFactorToken") { PhoneNumber = "4251234567" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            var stamp = user.SecurityStamp;
            Assert.NotNull(stamp);
            var token = await manager.GenerateTwoFactorTokenAsync(user, factorId);
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("GenerateTwoFactorWithUnknownFactorProviderWillThrow");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        {
            var manager = CreateManager();
            var user = new ApplicationUser("GetValidTwoFactorTestEmptyWithNoProviders");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task CanGetValidTwoFactor()
        {
            ...
            var user = new ApplicationUser("CanGetValidTwoFactor");
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
            var factors = await manager.GetValidTwoFactorProvidersAsync(user);
            Assert.NotNull(factors);
            Assert.True(!factors.Any());
        ...
        public async Task VerifyTokenFromWrongTokenProviderFails()
        {
            ...
            var user = new ApplicationUser("WrongTokenProviderTest") { PhoneNumber = "4251234567" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
        ...
        public async Task VerifyWithWrongSmsTokenFails()
        {
            ...
            const string factorId = "PhoneCode";
            manager.RegisterTwoFactorProvider(factorId, new SmsTokenProvider());
            var user = new ApplicationUser("VerifyWithWrongSmsTokenFails") { PhoneNumber = "4251234567" };
            IdentityResultAssert.IsSuccess(await manager.CreateAsync(user));
